...
namespace MEApp.Admin
{
    public partial class ViewDepartment : System.Web.UI.Page
    {
        ...
        {
            string deptName = GridView1.DataKeys[e.RowIndex].Value.ToString();
            ...
            {
                string query = "UPDATE Department SET Status = @Status WHERE DepartmentName = @DepartmentName";
        ...
        private void BindGrid()
        {
            ...
            SqlCommand cmd = new SqlCommand("select DepartmentName, Status from Department", conn);
